            ...
            <li class="nav mt-1">
                ...
                <div class="collapse" id="firm-collapse1">
                    <ul id="nav_dropdown" class="nav_dropdown list-unstyled fw-normal small">
                        <li id="nav_dropdown_li" class="pb-1 a1"><a class="fs-5 fw-bolder">廠商管理</a></li>
                        <li id="nav_dropdown_li" class="pb-1 a2"><a class="fs-5 fw-bolder">新增廠商</a></li>
                    </ul>
                </div>
            </li>
...
<script>
    $("#nav_dropdown li").click(function (){
        if($(".nav button").attr("aria-expanded")!==false) {
            $(".nav button").attr("aria-expanded",false) // 關掉其他發亮表面
            $(this).siblings().addClass("collapsed");
            $(".nav div").removeClass("show"); //其他表面關掉
        }
                                //遍立   //方法
