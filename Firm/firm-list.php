                            ...
                            <form name="firm" action="updateFirm.php" method="post">
                                ...
                                <div class="modal-body">
                                    <div>
                                        ...
                                        <input type="password" name="password" id="updatepassword" value="" /><br>
                                        <label for="">廠商名稱</label><br>
...
<div class="sorting d-flex justify-content-center">
    ...
    if($pages>1){  //總頁數>1才顯示分頁選單
        ...
        if($page=='1'){
            ...
            echo "<a href=?page=1&sort=$GET>首頁 </a> ";
            echo "<a href=?page=".($page-1)."&sort=$GET>上一頁 </a> ";
        }
        ...
        if($page==$pages){
            ...
            echo "<a href=?page=".($page+1)."&sort=$GET> 下一頁</a>";
            echo "<a href=?page=".$pages."&sort=$GET> 末頁</a>";
        }
    }
    ?>
</div>
